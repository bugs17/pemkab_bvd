...
import StafAhliSatuFoto from '../asset/img/stafahlisatu.jpg'
        ...
        <div className="flex justify-center w-full">
          <div className="group hover:saturate-100 saturate-0 transition-[filter] relative w-[310px] h-[530px] bg-white font-['Robot_Flex'] border-b-2 border-b-[#F04E29]">
            <Image
              ...
              alt="BUPATI"
              src={StafAhliSatuFoto}
            />
            <p className="m-[5px] text-[#262626] text-base font-bold">Drs. JEFFRI HANNY IZAAK NIRAHUA</p>
            <p className="m-[5px] text-[#777674] text-xs">STAF AHLI BUPATI BIDANG EKONOMI DAN KEUANGAN</p>
            <svg
