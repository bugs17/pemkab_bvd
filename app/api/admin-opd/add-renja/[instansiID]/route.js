...
export async function POST(req, {params}){
    ...
    try {
        ...
        // Path final
        const folderPath = path.join(process.cwd(), "file-opd", "renja")
        const filePath = path.join(folderPath, fileName)
        const namaFileDiDb = `/file-opd/renja/${fileName}`
        ...
        console.log("Error saat melakukan write file renja dan simpan ke DB", error.message)
