...
export async function POST(req, {params}){
    ...
    try {
        ...
        // Path final
        const folderPath = path.join(process.cwd(), "file-opd", "lppd")
        const filePath = path.join(folderPath, fileName)
        const namaFileDiDb = `/file-opd/lppd/${fileName}`
        ...
        console.log("Error saat melakukan write file lppd dan simpan ke DB", error.message)
