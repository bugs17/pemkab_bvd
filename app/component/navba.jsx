    ...
    <div onMouseEnter={() => setCloseMenu("")} className="bg-red-500 w-full flex flex-row sticky h-10">
      <div className="h-full w-[25%] flex items-center justify-end pr-6">
        <Link href={'mailto:info@bovendigoelkab.go.id'} target="_blank" className="flex items-center flex-row gap-2">
          ...
          <span className="text-white font-mono text-xs">info@bovendigoelkab.go.id</span>
        </Link>
      </div>
      ...
      <div className="h-full w-[50%] border-l border-r border-red-300 flex items-center justify-end">
        <div className="flex flex-row justify-end items-center gap-2 pr-6">
          ...
          <span className=" text-white ">Jl. Trans Papua, Kampung Persatuan, Distrik Mandobo, Boven Digoel</span>
        </div>
      </div>
