"use client";
import { updateSarana } from "@/app/actions/editSarana";
import React, { useEffect, useRef, useState } from "react";
import { MdEditDocument } from "react-icons/md";

const ButtonEditSaranaPrasarana = ({ id, judul }) => {
    ...
    <>
      <div className="tooltip z-50" data-tip="Edit">
        <MdEditDocument
          ...
          onClick={() =>
            document.getElementById(`modal_update_${judul}${id}`).showModal()
          }
        />
      </div>
...
export default ButtonEditSaranaPrasarana;
