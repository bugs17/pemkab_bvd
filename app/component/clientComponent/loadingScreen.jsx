...
const LoadingScreen = () => {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden py-20 z-[980] bg-slate-100 bg-[linear-gradient(to_right,#fca5a50a_1px,transparent_4px),linear-gradient(to_bottom,#fca5a50a_1px,transparent_4px)] bg-[size:14px_24px]">
