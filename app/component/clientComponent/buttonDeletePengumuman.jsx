"use client";
import { hapusPengumuman } from "@/app/actions/hapusPengumuman";
import React, { useState } from "react";

import { MdDelete } from "react-icons/md";

const ButtonDeletePengumuman = ({ id, judul }) => {
    const [isSubmit, setIsSubmit] = useState(false)

    const handleHapus = async () => {
        setIsSubmit(true)
        const response = await hapusPengumuman(id)
        if (response) {
...
export default ButtonDeletePengumuman;
