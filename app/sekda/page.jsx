...
import SekdaFoto from '../asset/img/sekda.jpg'
        ...
        <div className="flex justify-center w-full">
          <div className="group hover:saturate-100 saturate-0 transition-[filter] relative w-[310px] h-[530px] bg-white font-['Robot_Flex'] border-b-2 border-b-[#F04E29]">
            <Image
              ...
              src={SekdaFoto}
            />
            <p className="m-[5px] text-[#262626] text-base font-bold">Dr. PILEMON TABUNI,S.IP.,M.Si</p>
            <p className="m-[5px] text-[#777674] text-xs">Plt. SEKRETARIS DAERAH KABUPATEN BOVEN DIGOEL</p>
            <svg
