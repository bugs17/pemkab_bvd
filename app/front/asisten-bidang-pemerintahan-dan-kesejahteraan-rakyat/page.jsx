...
import AsistenBidangPemerintahan from '../../asset/img/asistenbidangpemerintahan.jpg'

const AsistenBidangPemerintahanDanKesejahteraanRakyat = () => {
  return (
    <div className="w-full bg-base-200 p-4 flex md:flex-row flex-col">
      <div className=" md:w-[70%] md:p-10">
        ...
        <div className="flex justify-center w-full">
          <div className="group hover:saturate-100 saturate-0 transition-[filter] relative w-[310px] h-[530px] bg-white font-['Robot_Flex'] border-b-2 border-b-[#F04E29]">
            <Image
              className="group-hover:rounded-br-[100px] rounded-br-[0px] transition-[border-radius]"
              alt="BUPATI"
              src={AsistenBidangPemerintahan}
            />
            <p className="m-[5px] text-[#262626] text-base font-bold">dr. VIVIANA MAHARANI PRADOTOKOESOEMO, MM</p>
            <p className="m-[5px] text-[#777674] text-xs">ASISTEN BIDANG PEMERINTAHAN DAN KESEJAHTERAAN RAKYAT</p>
            <svg
