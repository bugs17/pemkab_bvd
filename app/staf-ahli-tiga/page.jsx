...
import StafAhliTigaFoto from '../asset/img/nophoto.png'
        ...
        <div className="flex justify-center w-full">
          <div className="group hover:saturate-100 saturate-0 transition-[filter] relative w-[310px] h-[530px] bg-white font-['Robot_Flex'] border-b-2 border-b-[#F04E29]">
            <Image
              ...
              alt="BUPATI"
              src={StafAhliTigaFoto}
            />
            <p className="m-[5px] text-[#262626] text-base font-bold">ULOS ANUMBON, S.Sos</p>
            <p className="m-[5px] text-[#777674] text-xs">STAF AHLI BIDANG PEMERINTAHAN, HUKUM DAN POLITIK</p>
            <svg
